...
<form action="{{route('warehouses.product.insert')}}" method="POST" class="row" enctype="multipart/form-data">
        ...
        <div class="card ">
          ...
          <div class="card-body">
              <div class="form-group">
                ...
                <input required type="text" name="name" id="" class="form-control" placeholder="Enter the name of your Product">
              </div>
              <div class="form-group">
    ...
    <div class="col-md-4">
        ...
        <div class="input-group">
            <button class="btn btn-orange" type="submit">Submit Request <i class="fa fa-upload" aria-hidden="true"></i> </button>
        </div>
    </div>
</form>
